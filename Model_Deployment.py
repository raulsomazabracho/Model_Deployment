...
lr = pickle.load(open(r'C:/Users/54112/Documents/DATA_SCIENCE_PERSONAL/Ciencia_de_datos/Python/Regresion_(Supervised_Learning)/Titanic/Logistic-Regression-main/Logistic-Regression-main/logistic_regression_model.pkl','rb'))



# Le colocamos titulo y subitulo a la pagina
st.title("Habrias sobrevivido al titanic?")
st.subheader("Modelo predice si hubieras sobrevivido al titanic")

st.write("Aca estudiamos mediante varias variables si una persona hubiera sobrevivido al titanic o no")
...
if prediction == 1:
	...
	#st.subheader('Pasajero {} NO hubiera sobrevivido con una probabilidad {}%'.format(name, round(predict_probability[0][0]*100 , 3)))
